#!/usr/bin/env python3
"""LA MAIN (Tome 3, final de la trilogie) — relieur du roman. HTML + PDF + EPUB. Style Musso x De Villiers (SAS)."""
import os, subprocess
from pathlib import Path
import markdown2

BOOK_DIR = Path(__file__).parent
OUT_PDF  = BOOK_DIR / "La_Main.pdf"
OUT_EPUB = BOOK_DIR / "La_Main.epub"
OUT_HTML = BOOK_DIR / "La_Main.html"
...
TITLE   = "La Main"
SERIES  = "Les Dossiers Delta — Livre Troisième"
AUTHOR  = "deepload"
TAGLINE = "Il y a toujours un nom au-dessus des noms. Une main au-dessus de la main."
YEAR    = "2026"

ACTES = [
    ("Acte I — Le nom au-dessus des noms", ["ch01-le-dossier-non-demande.md","ch02-le-doyen.md","ch03-monnaie-denfants.md","ch04-tu-nes-pas-le-seul.md","ch05-marchetti-brule.md","ch06-le-phare-en-danger.md","ch07-noa-choisit.md","ch08-le-deuil-et-la-rage.md"]),
    ("Acte II — Le pari de la machine", ["ch09-qui-mene-qui.md","ch10-debrancher.md","ch11-lecole-dorigine.md","ch12-alliance-impossible.md","ch13-le-genome-de-la-main.md","ch14-clara-compromise.md","ch15-la-voie-propre-coute-tout.md","ch16-pas-deux-fois.md","ch17-la-rebellion-de-loutil.md","ch18-le-monde-prend-feu.md"]),
    ("Acte III — Le corps entier", ["ch19-le-dernier-convoi.md","ch20-les-enfants-dabord.md","ch21-loffre-du-doyen.md","ch22-le-defaut-encore.md","ch23-apprendre-a-perdre.md","ch24-voie-propre-echelle-monde.md","ch25-ce-que-ca-coute.md","ch26-la-lumiere-ordinaire.md"]),
]
...
def make_epub():
    ...
    book=epub.EpubBook(); book.set_identifier("la-main-t3"); book.set_title(TITLE); book.set_language("fr"); book.add_author(AUTHOR); book.add_metadata("DC","description",TAGLINE)
